...
def main():
    ...
    inputs = [ROOT / 'lookup_manifest.json', ROOT / 'sphere_adapter_validation.json',
              ROOT.parent / '21_sphere_reachability/config.json',
              ROOT.parent / '21_sphere_reachability/robot_open_spheres.yml']
