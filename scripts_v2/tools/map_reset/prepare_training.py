...
PYTHON = '/data/kanth042/envs/uwlab-isaac51/bin/python'
...
def main():
    ...
    environment = dict(CONDA_PREFIX='/data/kanth042/envs/uwlab-isaac51', CUDA_VISIBLE_DEVICES='3,4,5,7',
    ...
    asset_dirs = [Path('/data/kanth042/converted_assets') / d for d in (
