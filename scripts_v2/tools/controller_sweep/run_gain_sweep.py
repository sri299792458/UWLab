"""Paired 120 Hz gain trials using the existing explicit Cartesian action term."""
import argparse
...
out=ROOT/('pilot' if args.pilot else (args.output_name or args.phase))/f'worker_{args.worker}'
